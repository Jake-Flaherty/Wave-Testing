            ...
            <div className="py-16">
                <div className="mx-auto px-6 max-w-6xl text-gray-500">
                    <div className="text-center">
                        <h2 className="text-3xl text-gray-950 dark:text-white font-semibold">Replace these with wave colors and logos</h2>
                        <p className="mt-6 text-gray-700 dark:text-gray-300">This one comebined with feature 1 could be so cool or just having this somewhere.</p>
                    </div>
